...
Devise.setup do |config|
  ...
  # config.secret_key = 'e7dbec4a825ef34871ab1cf11c27c5a836cef5000deda603b1053a6bf1a2264a8ef47428b5a1a73a26ba72e63b767e6c6cecf7b3640b152731ffd92fd77f0c7d'
  ...
  # config.pepper = 'd3f7ff04dc28942ac261c8b49b28085f85fca13a01ddab8b3a16e1999c0b84d2564b4e8f63bcce141d307a19b69cfa42e5ad5613293355ff55ad4d26b9130894'
  ...
  config.omniauth :vkontakte, Rails.application.credentials.vkontakte[:omniauth_app_id],
                  Rails.application.credentials.vkontakte[:omniauth_secret_key],
                  callback_url: 'https://bbq-tomorrow.ru/users/auth/vkontakte/callback',
                  scope: 'name, email'

  # Настройки fb для development
  ...
  #
  # config.omniauth :vkontakte, Rails.application.credentials.facebook[:test_omniauth_app_id],
  #                 Rails.application.credentials.vkontakte[:test_omniauth_secret_key],
